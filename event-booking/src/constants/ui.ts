...
export const EVENTS = {
  ...
  SEARCH_DATE_LABEL: 'Fecha',
  SEARCH_ANY_DATE: 'Cualquier fecha',
  SEARCH_CLEAR_DATE: 'Limpiar fecha',
  SEARCH_DATE_MODAL_TITLE: 'Fecha para buscar',
  SEARCH_RESULTS_LABEL: 'Resultados',
  SEARCH_EMPTY_TITLE: 'Sin coincidencias',
  SEARCH_EMPTY_SUBTITLE: 'Intenta cambiar el texto, fecha o categoría.',
...
export const ADMIN = {
  ...
  DETAIL_DELETE_OPTION: 'Eliminar evento',
  DETAIL_DELETE_CONFIRM_TITLE: '¿Eliminar evento?',
  DETAIL_DELETE_CONFIRM_MESSAGE: 'Esta acción es permanente y no se puede deshacer. Se notificará por correo a todos los usuarios con reservaciones activas.',
  DETAIL_DELETE_CONFIRM_CANCEL: 'Cancelar',
  DETAIL_DELETE_CONFIRM_OK: 'Eliminar',
